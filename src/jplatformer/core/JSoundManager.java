...
public class JSoundManager {
    ...
    private static class SoundImpl extends Sound {
        ...
        public void play(float pitch, float volume) {
            super.play(pitch, (float) (volume * (JPlatformer.settings.get("sound").getValueAsDouble()/100.0))); //To change body of generated methods, choose Tools | Templates.
        }

        @Override
        public void playAt(float pitch, float volume, float x, float y, float z) {
            super.playAt(pitch, (float) (volume * (JPlatformer.settings.get("sound").getValueAsDouble()/100.0)), x, y, z); //To change body of generated methods, choose Tools | Templates.
        }

        @Override
        public void play() {
            super.play(1, (float) (1 * (JPlatformer.settings.get("sound").getValueAsDouble()/100.0)));
        }
        
        @Override
        public void loop() {
            super.loop(1, (float) (1 * (JPlatformer.settings.get("sound").getValueAsDouble()/100.0))); //To change body of generated methods, choose Tools | Templates.
        }
        
        @Override
        public void loop(float pitch, float volume) {
            super.loop(pitch, (float) (volume * (JPlatformer.settings.get("sound").getValueAsDouble()/100.0))); //To change body of generated methods, choose Tools | Templates.
        }
    }
}
